...
export const projects: Project[] = [
  {
    ...
    description: "A responsive website portfolio that was developed with React.js and TypeScript. The styles were added with the Styled-Components tool. It highlights my most relevant skills and projects.",
    img: "",
